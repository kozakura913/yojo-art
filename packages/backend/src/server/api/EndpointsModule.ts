...
import * as ep___officialTags_get from './endpoints/official_tags/get.js';
import * as ep___officialTags_update from './endpoints/official_tags/update.js';
...
const $officialTags_get: Provider = { provide: 'ep:officialTags/get', useClass: ep___officialTags_get.default };
const $officialTags_update: Provider = { provide: 'ep:officialTags/update', useClass: ep___officialTags_update.default };
