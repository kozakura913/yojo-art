...
export type OfficialTagsGetRequest = operations['official_tags___get']['requestBody']['content']['application/json'];
export type OfficialTagsUpdateRequest = operations['official_tags___update']['requestBody']['content']['application/json'];
